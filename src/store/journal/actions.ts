...
type SetAllJournalInfo = {
  type: typeof SET_JOURNAL_ALL
  payload: PartialJournalState
}
export const setAllJournalInfo = (
  payload: PartialJournalState
): JournalActions => ({ type: SET_JOURNAL_ALL, payload })
...
export const setJournalInfo = (payload: JournalObject): JournalActions => ({
  type: SET_JOURNAL_INFO,
  payload
})

type SetJournalAttrs = {
  type: typeof SET_JOURNAL_ATTRS
  payload: Array<JournalAttribute>
}
export const setJournalAttrs = (
  payload: Array<JournalAttribute>
): JournalActions => ({ type: SET_JOURNAL_ATTRS, payload })

type SetJournalViews = {
  type: typeof SET_JOURNAL_VIEWS
  payload: Array<JournalView>
}
export const setJournalViews = (
  payload: Array<JournalView>
): JournalActions => ({ type: SET_JOURNAL_VIEWS, payload })

type SetJournalNotes = {
  type: typeof SET_JOURNAL_NOTES
  payload: Array<NoteObject>
}
export const setJournalNotes = (
  payload: Array<NoteObject>
): JournalActions => ({ type: SET_JOURNAL_NOTES, payload })
...
export const SAGA_UPDATE_VIEW_ATTR_SETTING =
  'SAGA/JOURNAL/SAGA_UPDATE_VIEW_ATTR_SETTING'
export const SAGA_CREATE_VIEW = 'SAGA/JOURNAL/SAGA_CREATE_VIEW'
export const SAGA_UPDATE_VIEW = 'SAGA/JOURNAL/SAGA_UPDATE_VIEW'
export const SAGA_DELETE_VIEW = 'SAGA/JOURNAL/SAGA_DELETE_VIEW'
