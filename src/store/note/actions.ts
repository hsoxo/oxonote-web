...
export const SAGA_UPDATE_ATTRIBUTE_SELECT_RANGE =
  'SAGA/NOTE/SAGA_UPDATE_ATTRIBUTE_SELECT_RANGE'
export const SAGA_REMOVE_ATTRIBUTE =
  'SAGA/NOTE/export const SAGA_REMOVE_ATTRIBUTE'
