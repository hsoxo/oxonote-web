...
type SetJournals = {
  type: typeof SET_JOURNAL_LIST
  payload: Array<JournalObject>
}
export const setJournals = (payload: Array<JournalObject>) => ({
  type: SET_JOURNAL_LIST,
  payload
})

type SetLoginStatus = { type: typeof SET_LOGIN_STATUS; payload: RequestStatus }
export const setLoginStatus: (payload: RequestStatus) => SetLoginStatus = (
  payload: RequestStatus
) => ({ type: SET_LOGIN_STATUS, payload })

type SetSignUpStatus = {
  type: typeof SET_SIGN_UP_STATUS
  payload: RequestStatus
}
export const setSignUpStatus: (payload: RequestStatus) => SetSignUpStatus = (
  payload: RequestStatus
) => ({ type: SET_SIGN_UP_STATUS, payload })
...
export const setDBSyncStatus = (payload: string): SetDBSyncStatus => ({
  type: SET_DB_SYNC_STATUS,
  payload
})

type SetBrowserDBConn = {
  type: typeof SET_BROWSER_DB_CONN
  payload: PouchDB.Database
}
export const setBrowserDBConn = (payload: PouchDB.Database) => ({
  type: SET_BROWSER_DB_CONN,
  payload
})
...
type SetRemoteDBInfo = {
  type: typeof SET_REMOTE_DB_INFO
  payload: RemoteDBInfo
}
export const setRemoteDBInfo = (payload: RemoteDBInfo) => ({
  type: SET_REMOTE_DB_INFO,
  payload
})
